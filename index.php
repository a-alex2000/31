...
Детали автомобиля (рулевое колесо, педали, акустика, цвет кузова), которые мы видим реально - публичные свойства и методы, остальные ( двигатель, шестеренки, прокладки, болтики ) - скрытые от нас т.е. инкапсулированы.
Или - инкапсулированые свойства и методы нужны для нормальной работы публичных свойств и методов.
***
...
<br>
(-)
<br> Много теории( классы, объекты, абстракция, инкапсуляция, полиморфизм, пространство имен и т.д.).
</p>
